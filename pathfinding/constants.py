...
FIRST_CUBE_DROP_POSITION = {'direction': 'left',
                            'width_distance': 3 * WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                            'length_distance': LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
SECOND_CUBE_DROP_POSITION = {'direction': 'forward',
                             'width_distance': 3 * WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                             'length_distance': 0 * LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
THIRD_CUBE_DROP_POSITION = {'direction': 'right',
                            'width_distance': 3 * WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                            'length_distance': LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
FOURTH_CUBE_DROP_POSITION = {'direction': 'left',
                             'width_distance': 2 * WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                             'length_distance': LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
FIFTH_CUBE_DROP_POSITION = {'direction': 'forward',
                            'width_distance': 2 * WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                            'length_distance': 0 * LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
SIXTH_CUBE_DROP_POSITION = {'direction': 'right',
                            'width_distance': 2 * WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                            'length_distance': LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
SEVENTH_CUBE_DROP_POSITION = {'direction': 'left',
                              'width_distance': WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                              'length_distance': LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
EIGHT_CUBE_DROP_POSITION = {'direction': 'forward',
                            'width_distance': WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                            'length_distance': 0 * LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
NINTH_CUBE_DROP_POSITION = {'direction': 'right',
                            'width_distance': WIDTH_DISTANCE_TO_MOVE_TO_CHANGE_FLAG_COLUMN,
                            'length_distance': LENGTH_DISTANCE_TO_CHANGE_FLAG_ROW}
